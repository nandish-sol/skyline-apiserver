    ...
    ServicePolicies(
        ...
        categories={
            "Instance Lifecycle": [
                ...
                PolicyRule(
                    rule="nova:os_compute_api:os-remote-consoles",
            ...
            "Instance Actions": [
                ...
                PolicyRule(
                    rule="nova:os_compute_api:os-suspend-server:suspend",
                ...
                PolicyRule(
                    rule="nova:os_compute_api:os-suspend-server:resume",
                ...
                PolicyRule(
                    rule="nova:os_compute_api:os-pause-server:pause",
                ...
                PolicyRule(
                    rule="nova:os_compute_api:os-pause-server:unpause",
